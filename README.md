...
6. 👉 PYSPARK, AIRFLOW, POSTGRESQL  AUTOMATED WORKFLOW
 ===> https://www.youtube.com/watch?v=vMgFadPxOLk&t=1644s
 ===> https://youtube.com/playlist?list=PL2IsFZBGM_IHCl9zhRVC1EXTomkEp_1zm


   ✅ ===> Bodywork (ALL KEY CONCEPTS) + (GITHUB REPOS SOURCE CODE)
...
8.* PROJECTS
            ...
            ===> INTERNET/NETWORK ENGINEER
                 - Smart OLT System (Interfacing the Network Devices)
                 - Billing System
                 - Payment API System
                 - Messaging system
            ===> LOANS
...
# CYBERSECURITY, FINANCE, BLOCKCHAIN JOBS
...
✅ MISINFORMATION, DISINFORMATION, FALSE-FLAG ATTACK, SMEAR CAMPAIGN
...
4. DEFENSE
5. ADVANTAGE/ ADVANCE
6. DEVELOPMENT/ CHANGE
7. LEVERAGE-Increase Compounding & REDUNDANCY-Increase Backup
8. MATERIAL
9. ATTACK
```
...
✅ TOY                       👉 CFDS (Type of Derivative)
 ...
 >>> CFDs ---> (NOT AN ACTUAL STOCK) (BASED ON AN ACTUAL ASSET/SECURITY) (CONTRACT BETWEEN YOU AND BROKER)
     Contract For Difference Examples: Shares/Equity, Commodities, Forex, Cryptocurrencies
...
5. RETEST,
✅ENTRY:
6. THEN _ MOVES TO THE OPPOSITE DIRECTION,
🧨EXIT:
...
```
🧨🧨🧨 CANDLESTICK / PD-ARRAY => OBEYS [BUY-SIDE/SELL-SIDE LIQUIDITY] + [PREMIUM/DISCOUNT PRICE LEVEL]
...
> Buy-Side Liquidity STRATEGY ==> STOP-LOSS HUNT

> Sell-Side Liquidity STRATEGY ==> STOP-LOSS HUNT
...
# ICT STRATEGY [ENTRY/EXIT - LOWER TIME FRAME]
...
> SWING HIGH -> IS A BUY STOP

> SWING LOW -> IS A SELL STOP

> CONSISTENT SWING HIGH -> RESISTANCE

> CONSISTENT SWING LOW -> SUPPORT

> ORDERBLOCK -> IS A TYPE OF PD-ARRAY
  ===> PREMIUM ARRAY  -> ORDERBLOCK / BUY SIDE LIQUIDITY (RESISTANCE LEVEL) ---> SELL LIMIT ORDER 
  ===> DISCOUNT ARRAY -> ORDERBLOCK / SELL SIDE LIQUIDITY (SUPPORT LEVEL)   ---> BUY LIMIT ORDER 
...
👉 INCOME TAX = 30% * GROSS ===> EMPLOYEE/SELF PROPRIETORSHIP/PARTNERSHIP OWNERS/DIVIDENDS OF SHAREHOLDERS/CORPORATE
👉👉👉 PAYEE MUST BE FILED BY EMPLOYER
👉 WITHHOLDING TAX == 30%
Procedure:
...
- Stock-Indices-Selection-Research ===> https://devopsengineerdan.github.io/firstproject/Methodology%20_%20Portfolio_Management.html
